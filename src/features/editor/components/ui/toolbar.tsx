...
import { FontSizeInput } from "@/features/editor/components/tools/font-size-input";
import { 
  ActiveTool, 
  Editor, 
  FONT_SIZE, 
...
export const Toolbar = ({
  ...
  if (editor?.selectedObjects.length === 0) {
    return (
      <div className="shrink-0 h-[48px] border-b  w-full flex items-center overflow-x-auto z-[49] p-2 gap-x-2 bg-primary" />
    );
  }
  ...
  return (
    <div className="shrink-0 h-[48px] border-b  w-full flex items-center overflow-x-auto z-[49] p-2 gap-x-2 bg-primary">
      ...
      {isText && (
        <div className="flex items-center h-full justify-center">
          <Hint label="Жирний" side="bottom" sideOffset={5}>
            <Button
              onClick={toggleBold}
              size="icon"
              variant="ghost"
      ...
      {isText && (
        <div className="flex items-center h-full justify-center">
          <Hint label="Курсив" side="bottom" sideOffset={5}>
            <Button
      ...
      {isText && (
        <div className="flex items-center h-full justify-center">
          <Hint label="Текст зліва" side="bottom" sideOffset={5}>
            <Button
      ...
      {isText && (
        <div className="flex items-center h-full justify-center">
          <Hint label="Текст по центру" side="bottom" sideOffset={5}>
            <Button
      ...
      {isText && (
        <div className="flex items-center h-full justify-center">
          <Hint label="Текст справа" side="bottom" sideOffset={5}>
            <Button
